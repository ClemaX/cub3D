...
SRCS	= $(addprefix $(SRCDIR)/, cub3d.c environment.c ray.c canvas.c color.c map.c vector.c settings.c hooks.c player.c)
HDRS	= $(addprefix $(INCDIR)/, environment.h ray.h color.h map.h vector.h)
