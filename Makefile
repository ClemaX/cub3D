...
SRCS	= $(addprefix $(SRCDIR)/, cub3d.c environment.c ray.c image.c color.c map.c vector.c settings.c hooks.c)
HDRS	= $(addprefix $(INCDIR)/, cub3d.h environment.h ray.h color.h map.h vector.h cub.h hooks.h)
