...
SRCS	= $(addprefix $(SRCDIR)/, cub3d.c environment.c ray.c image.c color.c map.c vector.c cub.c settings.c hooks.c get_next_line.c get_next_line_utils.c)
HDRS	= $(addprefix $(INCDIR)/, cub3d.h environment.h ray.h color.h map.h vector.h cub.h hooks.h get_next_line.h)
