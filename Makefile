...
SRCS	= $(addprefix $(SRCDIR)/, cub3d.c environment.c ray.c images.c canvas.c color.c map_read.c map.c cell.c vector.c vmath.c settings.c hooks.c input.c error.c tick.c sprite.c sprite_utils.c)
